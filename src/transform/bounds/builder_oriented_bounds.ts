 ...
 */
export class BuilderOrientedBounds {
   ...
   */
  buildFromMeshes(meshes: THREE.Mesh[]): DataOrientedBounds | null {
   ...
   */
  getFaceNormal(bounds: DataOrientedBounds, face: BoundsFace): THREE.Vector3 {
   ...
   */
  getFaceCenter(bounds: DataOrientedBounds, face: BoundsFace): THREE.Vector3 {
   ...
   */
  private buildFromSingleMesh(mesh: THREE.Mesh): DataOrientedBounds {
   ...
   */
  private buildWorldAxisAlignedUnion(meshes: THREE.Mesh[]): DataOrientedBounds {
