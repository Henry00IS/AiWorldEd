...
export type MetricUnit = 'millimeter' | 'centimeter' | 'meter' | 'kilometer';
...
export const METRIC_UNIT_LABELS: Readonly<Record<MetricUnit, string>> = Object.freeze({
...
export const IMPERIAL_UNIT_LABELS: Readonly<Record<ImperialUnit, string>> = Object.freeze({
  inch: 'Inch',
  foot: 'Foot',
  yard: 'Yard',
  mile: 'Mile',
 ...
 */
export function getUnitLabel(system: UnitSystem, unit: MetricUnit | ImperialUnit): string {
  if (system === 'metric') {
