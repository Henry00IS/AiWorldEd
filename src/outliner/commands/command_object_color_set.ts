...
/**
 * Undoable command that sets material colors on one or more meshes. Snapshots
 * original colors on construction and restores them on undo.
 */
export class CommandObjectColorSet implements UndoCommand {
   ...
   * @param originalColorHexes Optional per-mesh undo colors matching meshes
   *   order.
   */
  ...
  /**
   * Resolves the undo color for a mesh from explicit originals or live
   * material.
   *
